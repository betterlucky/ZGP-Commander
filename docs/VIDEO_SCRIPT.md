...
| --- | --- | --- |
| 0:00–0:14 | Demo intro; pause on the hook | “ZGP Commander is a squad-tactics game seen through an incomplete remote sensor feed. Combat is automatic. Your decisions are who to risk, how far to push, and when to leave.” |
| 0:14–0:32 | Begin demo; show mission and preselected four-person squad | “At the living outpost, persistent survivors have roles, equipment and jobs. Opportunities declare their risk and rewards before I choose a squad.” |
| 0:32–0:52 | Establish Ghostlink; pan briefly across the point-cloud floor | “Ghostlink reconstructs the operation as a live point cloud. Friendly telemetry is reliable, but the environment and contacts are deliberately incomplete.” |
| 0:52–1:13 | Press F, breach and move to the first cache | “I issue high-level orders while the squad moves, covers and fights automatically. Breaching creates access—but it also exposes the link to rising contact pressure.” |
| 1:13–1:37 | Right-click cache; show Holt scavenging and others covering | “A cache order automatically assigns my best scavenger. The others cover him, ammunition drains, and standing still to reload has consequences.” |
...
- Use the deployed build, not localhost.
- Keep the complete upload below three minutes.
- Say both **Codex** and **GPT-5.6** aloud.
- Use clear spoken audio; no copyrighted music.
